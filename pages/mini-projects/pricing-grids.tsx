          ...
          <div className="bg-slate-700 rounded-xl text-white">
            <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
              ...
              <div className="flex justify-center">
                <a
                  href="#"
                  className="text-white inline-block px-10 py-3 my-6 text-center border border-violet-600 rounded-lg hover:bg-violet-800 hover:border-violet-800 hover:text-white"
                >
                  Purchase
                </a>
              </div>
          ...
          <div className="bg-violet-600 rounded-xl text-white">
            <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
              ...
              <div className="flex justify-center">
                <a
                  href="#"
                  className="text-white inline-block px-10 py-3 my-6 text-center border border-violet-600 rounded-lg 
                  bg-violet-600
                  hover:bg-violet-800 hover:border-violet-800 hover:text-white"
                >
                  Purchase
                </a>
              </div>
...
export default PricingGridsPage;
